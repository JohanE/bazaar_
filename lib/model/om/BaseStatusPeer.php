...
abstract class BaseStatusPeer {
	...
	const TABLE_NAME = 'internetbazar_status';
	...
	const ID = 'internetbazar_status.ID';

	
	const DESCRIPTION = 'internetbazar_status.DESCRIPTION';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(StatusPeer::DESCRIPTION);
