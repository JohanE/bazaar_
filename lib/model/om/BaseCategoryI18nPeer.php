...
abstract class BaseCategoryI18nPeer {
	...
	const TABLE_NAME = 'internetbazar_category_i18n';
	...
	const ID = 'internetbazar_category_i18n.ID';

	
	const CULTURE = 'internetbazar_category_i18n.CULTURE';

	
	const NAME = 'internetbazar_category_i18n.NAME';
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new CategoryI18nMapBuilder();
		}
	...
	public static function doCountJoinCategory(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(CategoryI18nPeer::ID,), array(CategoryPeer::ID,), $join_behavior);
	...
	public static function doSelectJoinCategory(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(CategoryI18nPeer::ID,), array(CategoryPeer::ID,), $join_behavior);
...
Propel::getDatabaseMap(BaseCategoryI18nPeer::DATABASE_NAME)->addTableBuilder(BaseCategoryI18nPeer::TABLE_NAME, BaseCategoryI18nPeer::getMapBuilder());
