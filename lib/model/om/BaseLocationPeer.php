...
abstract class BaseLocationPeer {
	...
	const TABLE_NAME = 'internetbazar_location';
	...
	const ID = 'internetbazar_location.ID';

	
	const CONNECTED_TO = 'internetbazar_location.CONNECTED_TO';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ConnectedTo', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'connectedTo', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CONNECTED_TO, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'connected_to', ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ConnectedTo' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'connectedTo' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CONNECTED_TO => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'connected_to' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new LocationMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LocationPeer::CONNECTED_TO);
  ...
  public static function doSelectWithI18n(Criteria $c, $culture = null, PropelPDO $con = null)
  {
    ...
    $c->addJoin(LocationPeer::ID, LocationI18nPeer::ID);
    $c->add(LocationI18nPeer::CULTURE, $culture);
...
Propel::getDatabaseMap(BaseLocationPeer::DATABASE_NAME)->addTableBuilder(BaseLocationPeer::TABLE_NAME, BaseLocationPeer::getMapBuilder());
